...
public class ManaBarOverlay implements HudRenderCallback {
    ...
    public void onHudRender(DrawContext drawContext, float tickDelta) {
        ...
        //Draws the orb.
        drawContext.drawTexture(new Identifier(PlayerAbilities.modId, "textures/gui/mana_orb.png"), screenWidth / 2 + 96, screenHeight - 15, 0, 0, 11, 11);
        ...
        drawContext.drawTexture(endCap, startingX, drawY, 0, 0, 1, 7);
        ...
        drawContext.drawTexture(endCap, endingX, drawY, 0, 0, 1, 7);
    ...
    private void drawSegment(DrawContext drawContext, int x, int y, float litSegments, int startingX, Identifier texture1, Identifier texture2) {
        if (x < litSegments + startingX + 3) {
            drawContext.drawTexture(texture1, x, y, 0, 0, 1, 7);
        } else {
            drawContext.drawTexture(texture2, x, y, 0, 0, 1, 7);
        }
    }
}
